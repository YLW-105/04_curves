...
def add_curve(points, x0, y0, x1, y1, x2, y2, x3, y3, step, curve_type):
    ...
    t = 0
    while t < 1:
        x1 = x[0][0] * t**3 + x[0][1] * t**2 + x[0][2] * t + x[0][3]
        y1 = y[0][0] * t**3 + y[0][1] * t**2 + y[0][2] * t + y[0][3]

        x2 = x[0][0] * (t + step) ** 3 + x[0][1] * (t + step) ** 2 + x[0][2] * (t + step) + x[0][3]
        y2 = y[0][0] * (t + step) ** 3 + y[0][1] * (t + step) ** 2 + y[0][2] * (t + step) + y[0][3]
